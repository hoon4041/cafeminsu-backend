...
public class MenuController {
    ...
    public MenuCreateRes create(@LoginUserId Long userId,
                                @PathVariable Long storeId,
                                @Valid @RequestBody MenuCreateReq req) {
        return menuService.createMenu(userId, storeId, req);
    }
    ...
    public List<MenuListItemRes> listByStore(@PathVariable Long storeId,
                                             @RequestParam(required = false) String category) {
        return menuService.getStoreMenus(storeId, category);
    }
    ...
    public MenuDetailRes detail(@PathVariable Long menuId) {
    ...
    public void changeAvailability(@LoginUserId Long userId,
                                   @PathVariable Long menuId,
    ...
    public MenuOptionCreateRes addOption(@LoginUserId Long userId,
                                         @PathVariable Long menuId,
                                         @Valid @RequestBody MenuOptionCreateReq req) {
        return menuService.addOption(userId, menuId, req);
    }

    /* 8. 옵션 수정 */
    @Operation(summary = "메뉴 옵션 수정")
    @PatchMapping("/api/menu-options/{optionId}")
    public void updateOption(@LoginUserId Long userId,
    ...
    public void deleteOption(@LoginUserId Long userId,
                             @PathVariable Long optionId) {
