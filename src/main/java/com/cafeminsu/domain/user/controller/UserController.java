...
public class UserController {
    ...
    public KakaoLoginRes kakaoLogin(@Valid @RequestBody KakaoLoginReq req) {
        return userService.kakaoLogin(req.accessToken());
    }
    ...
    public OwnerLoginRes ownerLogin(@Valid @RequestBody OwnerLoginReq req) {
        return userService.ownerLogin(req.loginId(), req.password());
    }
    ...
    @PostMapping("/signup")
    public SignupRes signup(@LoginUserId Long userId,
                            @Valid @RequestBody SignupReq req) {
        return userService.signup(userId, req);
    }
    ...
    @PostMapping("/refresh")
    public RefreshRes refresh(@RequestHeader("Refresh-Token") String refreshToken) {
    ...
    public NicknameCheckRes checkNickname(@RequestParam String nickname) {
    ...
    public NicknameChangeRes changeNickname(@LoginUserId Long userId,
                                            @Valid @RequestBody NicknameChangeReq req) {
        return userService.changeNickname(userId, req.nickname());
    }

    /* 7. 위치 저장 */
    @Operation(summary = "위치 저장", description = "주변 매장 검색용. 앱 실행 시 위치 권한 허용 후 호출.")
    @PostMapping("/location")
    public void saveLocation(@LoginUserId Long userId,
    ...
    @GetMapping("/location")
    public LocationRes getLocation(@LoginUserId Long userId) {
    ...
    @GetMapping("/profile")
    public UserProfileRes getMyProfile(@LoginUserId Long userId) {
    ...
    public OtherUserProfileRes getOtherProfile(@PathVariable Long userId) {
    ...
    public void updateFcmToken(@LoginUserId Long userId,
    ...
    public BecomeOwnerRes becomeOwner(@LoginUserId Long userId) {
        return userService.becomeOwner(userId);
    }
}
